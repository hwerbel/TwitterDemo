...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        TweetsNavigationController.tabBarItem.title = "Timeline"
        TweetsNavigationController.tabBarItem.image = UIImage(named: "homeIcon.png")
        ...
        let profilePageViewController = ProfileNavigationController.topViewController as! ProfileViewController
        ProfileNavigationController.tabBarItem.title = "Me"
        ProfileNavigationController.tabBarItem.image = UIImage(named: "profileIcon.png")
        profilePageViewController.user = User.currentUser
        
        let tabBarController = UITabBarController()
        tabBarController.viewControllers = [TweetsNavigationController, ProfileNavigationController]
        tabBarController.tabBar.tintColor = UIColor(red: 85/225.0, green: 172/225.0, blue: 238/225.0, alpha: 1.0)
        */
